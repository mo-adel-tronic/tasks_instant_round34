...
import 'package:r34_24/core/network/http_provider.dart';
...
void init() {
  ...
  sl.registerLazySingleton <BookRemoteDatasource>(
    () => BookRemoteDatasourceImpl(apiProvider: sl()),
  );
...
UserRemoteDatasource userRemoteDatasource = sl<UserRemoteDatasource>();
