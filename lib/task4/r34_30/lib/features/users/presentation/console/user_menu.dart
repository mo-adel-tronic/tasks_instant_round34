...
class UserMenu {
  ...
  Future<void> _createUser() async {
    ...
    if (firstName != null && firstName.isNotEmpty && email != null && email.isNotEmpty) {
      await _userService.createUser(firstName, email);
    } else {
  ...
  Future<void> _updateUser() async {
    ...
    final id = stdin.readLineSync();
    print('Enter new user firstName: ');
    final firstName = stdin.readLineSync();
    ...
    if (id != null && id.isNotEmpty &&
      ...
      await _userService.updateUser(id, firstName, email);
    } else {
      print('All fields are required.');
    }
  }
