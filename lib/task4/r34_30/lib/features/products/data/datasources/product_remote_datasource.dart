import 'package:task4/core/constants/url.dart';
import 'package:task4/core/error/exceptions.dart';
import 'package:task4/core/network/api_provider.dart';
import 'package:task4/features/products/data/models/product_model.dart';
...
class ProductRemoteDataSourceImpl implements ProductRemoteDataSource {
  ...
  static const _baseUrl = URLConstants.baseUrl + URLConstants.productsEndpoint;
  ...
  Future<ProductModel> updateProduct(ProductModel product) async {
    try {
      ...
      final json = await apiProvider.put('$_baseUrl/${product.id}', body: body);
      return ProductModel.fromJson(json as Map<String, dynamic>);
    } on NotFoundException {
      throw NotFoundException();
    } on BadRequestException {
