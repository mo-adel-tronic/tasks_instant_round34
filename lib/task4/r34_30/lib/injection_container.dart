...
import 'package:r34_30/core/network/http_provider.dart';
import 'package:r34_30/features/posts/data/datasource/posts_remote_datasource.dart';
import 'package:r34_30/features/posts/data/repositories/posts_repostory_imp.dart';
...
import 'package:r34_30/features/posts/presentation/console/posts_menu.dart';
import 'package:r34_30/features/posts/presentation/services/posts_console_service.dart';
import 'package:r34_30/features/product/data/datasource/product_remote_datasource.dart';
import 'package:r34_30/features/product/data/repositories/product_repostory_imp.dart';
...
import 'package:r34_30/features/product/presentation/console/product_menu.dart';
import 'package:r34_30/features/product/presentation/services/product_console_service.dart';
import 'package:r34_30/features/user/data/datasource/user_remote_datasource.dart';
import 'package:r34_30/features/user/data/repositories/user_repostory_imp.dart';
...
import 'package:r34_30/features/user/presentation/console/user_menu.dart';
...
void init() {
  // core providers
  k1.registerLazySingleton<ApiProvider>(() => HttpProvider());

  // Data sources
  k1.registerLazySingleton<ProductRemoteDataSource>(
    () => ProductRemoteDataSourceImpl(apiProvider: k1()),
  );
  k1.registerLazySingleton<UserRemoteDataSource>(
    () => UserRemoteDatasourceImp(apiProvider: k1()),
  );
  k1.registerLazySingleton<PostsRemoteDataSource>(
    () => PostsRemoteDataSourceImpl(apiProvider: k1()),
  );
  ...
  k1.registerFactory(() => ProductMenu(k1<ProductConsoleService>()));
  k1.registerFactory(() => UserMenu(k1<UserConsoleService>()));
  k1.registerFactory(() => PostMenu(k1<PostConsoleService>()));
}
